...
//                 {0.25,0.25,0.5,0.5,-0.5,-0.25}};
    ...
    float x[6][6]={{2,-2,-4.0,4.0,4.0,2},
                   {0.5,-0.5,-1.0,1.0,1.0,0.5},
                   {0.25,-0.25,-0.5,0.5,0.5,0.25},
                   {0.25,-0.25,-0.5,0.5,0.5,0.25},
                   {0.5,-0.5,-1.0,1.0,1.0,0.5},
                   {0.25,-0.25,-0.5,0.5,0.5,0.25}};
    float y[6][6]={{2,-2,-4.0,4.0,4.0,2},
                   {0.5,0.5,1.0,1.0,-1.0,-0.5},
                   {0.25,0.25,0.5,0.5,-0.5,-0.25},
                   {0.25,0.25,0.5,0.5,-0.5,-0.25},
                   {0.5,0.5,1.0,1.0,-1.0,-0.5},
